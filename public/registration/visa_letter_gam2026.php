...
if ($_SERVER['REQUEST_METHOD'] === 'POST' || $debug) {
    ...
    if ($debug) {
      ...
      $requiredFields = ['title', 'firstName', 'lastName', 'email', 'role', 'address1', 'address2', 'address3', 'country'];
      $missingFields = [];
